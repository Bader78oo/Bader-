...
7. **QA before delivery.** Check lip-sync offset (cross-correlate clip audio vs talk mp3 — expect 0 ms), loudness ≈ −14 LUFS, and `qa_sheet.jpg`. Give Bader the `d2ol7oe51mr4n9.cloudfront.net/...` link and phone download steps.
